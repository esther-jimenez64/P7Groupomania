<template> <!--v-on écoute du clic retirant l'événement default en mettant la function guardar-->
...
export default {
  ...
  methods: {/*objet méthode pour déclarer mes function utiles  pour effectuer une action avec la directive v-on sur un élément pour gérer les événements*/
    guardar() {  /*Fonction qui écoute le clic et supprimé le post en question grâce à l'id*/
