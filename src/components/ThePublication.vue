<template>
  ...
  <div class="center">
  <img src="https://tse1.mm.bing.net/th?id=OIP.etoPZN5PSRA0lJXcXCm_KAHaHa&amp;pid=Api&amp;rs=1&amp;c=1&amp;qlt=95&amp;w=123&amp;h=123" alt="..." class="chex"><span>{{ this.counter.username }}</span>
  </div>
